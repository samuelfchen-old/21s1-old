...
public class Student {
     ...
     * @param preferredName May be null or empty. May not be more than 16 characters in length.
     * @throws IllegalArgumentException If any parameter preconditions are violated.
     */
    public Student(String SID, String unikey, String name, String preferredName) throws IllegalArgumentException {
        ...
        if (unikey.length() != 8) throw new IllegalArgumentException("Code must be 4 letters and 4 numbers");
        if (!(unikey.substring(0,4).chars().allMatch(Character::isAlphabetic) &&
